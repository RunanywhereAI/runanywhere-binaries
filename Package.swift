...
//   dependencies: [
//       .package(url: "https://github.com/RunanywhereAI/runanywhere-binaries.git", from: "0.0.1-dev.6ab47eb")
//   ]
//   targets: [
...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "RunAnywhereCore",
            url: "https://github.com/RunanywhereAI/runanywhere-binaries/releases/download/v0.0.1-dev.6ab47eb/RunAnywhereCore.xcframework.zip",
            checksum: "cd550ec12d88c66f9f16a1ee616dd489c49f04a07c8988c99ef384d19cac27c6"
        ),
    ]
)
