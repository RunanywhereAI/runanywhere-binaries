...
//   dependencies: [
//       .package(url: "https://github.com/RunanywhereAI/runanywhere-binaries.git", from: "0.0.1-dev.27bdcd0")
//   ]
//   targets: [
...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "RunAnywhereCore",
            url: "https://github.com/RunanywhereAI/runanywhere-binaries/releases/download/v0.0.1-dev.27bdcd0/RunAnywhereCore.xcframework.zip",
            checksum: "81f6d24230807dff93b6cb0d590f3dd82f69349ad47167c7cb6074903bc2af18"
        ),
    ]
)
